...
\end{figure}
 ...
 \begin{figure}[h]
	\center{\includegraphics[width=0.8\textwidth]{I_5.pdf}}
	\caption{График $S_n(\alpha), 0 \leq \alpha \leq \dfrac{\pi}{2}$}
	\label{pic:FeOpt5}
\end{figure}
...
\begin{table}[h!]
 ...
 Проведем аналогичные расчеты и построим графики для пористого двухфазного сплава-смеси пары металлов Fe и Cd при фиксированных значениях объемной пористости в зависимости от отношения $V1/(V1 + V2) \in [0, 1]$, где $V1$ и $V2$ -- объемные доли железа и кадмия в сплаве соответственно, $V3$ — объемная пористость, $V1 + V2 + V3 = 1$.
    ...
    \begin{figure}[h]
        \center{\includegraphics[width=\textwidth]{lambdaj0.pdf}}
    ...
    \begin{figure}[h]
        \center{\includegraphics[width=0.9\textwidth]{muj0.pdf}}
        \caption{График $\mu(V_4), V_3 = 0$}
    \end{figure}

    \begin{figure}[h]
        \center{\includegraphics[width=\textwidth]{Ej0.pdf}}
    ...
    \begin{figure}[h]
        \center{\includegraphics[width=0.9\textwidth]{nuj0.pdf}}
        \caption{График $\nu(V_4), V_3 = 0$}
    \end{figure}

    \begin{figure}[h]
        \center{\includegraphics[width=\textwidth]{lambdaj1.pdf}}
    ...
    \begin{figure}[h]
        \center{\includegraphics[width=0.9\textwidth]{muj1.pdf}}
        \caption{График $\mu(V_4), V_3 = 0.1$}
    \end{figure}

    \begin{figure}[h]
        \center{\includegraphics[width=\textwidth]{Ej1.pdf}}
    ...
    \begin{figure}[h]
        \center{\includegraphics[width=\textwidth]{nuj1.pdf}}
        \caption{График $\nu(V_4), V_3 = 0.1$}
    \end{figure}
